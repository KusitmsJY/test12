package com.example.kb_google.Activity;
...
import com.example.kb_google.Adapter.ChatMessageAdapter;
import com.example.kb_google.Model.Chat;
import com.example.kb_google.Model.Emotion;
import com.example.kb_google.R;
import com.example.kb_google.Utils.Constant;
import com.example.kb_google.Utils.DateFormat;

import java.util.ArrayList;

import static com.example.kb_google.Utils.Constant.ACTION_DONE;
import static com.example.kb_google.Utils.Constant.ACTION_START;
...
public class ChatBotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Chat chat = new Chat(current_name, current_room_no, DateFormat.date_apm(), "안녕하세요. Emo에요~ 당신의 감정을 알려주세요", false, ACTION_START);
        chats.add(chat);
