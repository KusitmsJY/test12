...
public class RestPersonController {
    ...
    public int checkid( @RequestParam String id) {
        logger.info("/rest/checkid");
    
        return DataStorePerson.checkid( id );
    } 
    
    @RequestMapping(value = "/loginperson", method = {RequestMethod.GET, RequestMethod.POST} )
    @ResponseBody
    public ModelPerson loginperson( @RequestParam String id, @RequestParam String pw) {
    ...
    public List<ModelPerson> selectparam( @RequestParam String name ) {
        ...
        return DataStorePerson.selectlist(person); 
    }    
    ...
    @ResponseBody
    public List<ModelPerson> selectpaging( @RequestParam(value="start", defaultValue = "0" ) Integer start
    ...
    @ResponseBody
    public boolean insertjsonobject(@RequestBody ModelPerson person) {
